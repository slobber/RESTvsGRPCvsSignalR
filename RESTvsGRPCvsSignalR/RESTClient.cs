...
public class RESTClient
{
  ...
  public async Task<List<MeteoriteLanding>> GetLargePayloadAsync()
  {
    ...
    var meteoriteLandingsString =
      await client.GetStringAsync("http://localhost:5000/api/MeteoriteLandings/LargePayload");
  ...
  public async Task<string> PostLargePayloadAsync(List<MeteoriteLanding> meteoriteLandings)
  {
    ...
    var response =
      await client.PostAsJsonAsync("http://localhost:5000/api/MeteoriteLandings/LargePayload", meteoriteLandings);
